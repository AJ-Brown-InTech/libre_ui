...
import { Query,QueryCache, QueryClient, QueriesOptions, QueryClientProvider } from '@tanstack/react-query'; // state management, cache, pretty much a small piece of heaven
...
class App extends React.Component {
  ...
  render (){
    const rqueryClient = new QueryClient()
